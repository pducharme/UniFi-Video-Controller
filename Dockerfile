...
RUN apt-get update && \
  ...
  wget -q https://dl.ubnt.com/firmwares/unifi-video/3.7.3/unifi-video_3.7.3-Ubuntu14.04_amd64.deb && \
  dpkg -i unifi-video_3.7.3-Ubuntu14.04_amd64.deb && \
  patch -N /usr/sbin/unifi-video /unifi-video.patch && \
  rm /unifi-video_3.7.3-Ubuntu14.04_amd64.deb && \
