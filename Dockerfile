...
RUN apt-get update && \
  ...
  wget -q http://dl.ubnt.com/firmwares/unifi-video/3.7.2/unifi-video_3.7.2-Ubuntu16.04_amd64.deb && \
  dpkg -i unifi-video_3.7.2-Ubuntu16.04_amd64.deb && \
  patch -N /usr/sbin/unifi-video /unifi-video.patch && \
  rm /unifi-video_3.7.2-Ubuntu16.04_amd64.deb && \
