...
RUN apt-get update && \
  ...
  wget -q https://dl.ubnt.com/firmwares/ufv/v3.8.0-beta.2/unifi-video.Ubuntu16.04_amd64.v3.8.0-beta.2.deb && \
  dpkg -i unifi-video.Ubuntu16.04_amd64.v3.8.0-beta.2.deb && \
  patch -N /usr/sbin/unifi-video /unifi-video.patch && \
  rm /unifi-video.Ubuntu16.04_amd64.v3.8.0-beta.2.deb && \
